...
<Accordion title="Zobrazit divize LSPD" icon="users-gear">
    ...
    <CardGroup cols={2}>
    	...
    	<Card title="Air Support Division" icon="helicopter">
    		<div className="py-2" />
    		...
    		<div className="px-1">
    			<p className="text-sm opacity-70 leading-relaxed mb-6 min-h-[4rem]">
    				Oficiální logo Air Support Division.
    			</p>
    		</div>
    		<div className="mt-2">
    			<a
...
<div className="flex justify-center mt-16 mb-8">
	<div className="flex items-center gap-3 px-6 py-3 bg-neutral-900 border border-white/5 rounded-xl">
		<Icon icon="shield-check" iconType="solid" color="#ffd000" size={16} />
		<span className="text-xs text-white/60 font-medium uppercase tracking-widest">
			Tento Brand Guide je závazný pro všechny oficiální materiály.
		</span>
	</div>
</div>
